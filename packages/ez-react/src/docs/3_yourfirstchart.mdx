...
<Meta title="Get Started/Your First Chart" parameters={{ options: { isToolshown: false }, id: 3 }} />
...
<Tabs tabbedClassName="story-tabbed-code-block-very-small" showTabs={true}>
  <Tab title="npm" language="bash" code={`npm run start`} />

  <Tab title="yarn" language="bash" code={`yarn start`} />
</Tabs>
