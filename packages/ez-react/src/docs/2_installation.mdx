...
<Tabs tabbedClassName="story-tabbed-code-block-very-small" showTabs={true}>
  <Tab title="npm" language="bash" code={`npm install --save eazychart-react eazychart-css`} />

  <Tab title="yarn" language="bash" code={`yarn add eazychart-react eazychart-css`} />
</Tabs>
